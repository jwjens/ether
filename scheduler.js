...
console.log('\n  Ether — Show Scheduler + Category Rotation\n');

// ============================================================
// 1. Update database client with new tables
// ============================================================

let client = fs.readFileSync('src/db/client.ts', 'utf8');

if (!client.includes('dayparts')) {
  // Add new tables after songs table creation
  ...
  console.log('  UPDATED src/db/client.ts (shows, clocks, schedule tables)');
}

// ============================================================
// 2. Scheduler page component
// ============================================================
...
console.log('  CREATED src/components/Scheduler.tsx');

// ============================================================
// 3. Wire Scheduler into App.tsx
// ============================================================

let app = fs.readFileSync('src/App.tsx', 'utf8');

// Add import
if (!app.includes('Scheduler')) {
  app = app.replace(
  ...
  // Rename "Clocks" to "Schedule" in nav
  app = app.replace(
    '{ id: "clocks", label: "Clocks" }',
    '{ id: "clocks", label: "Schedule" }'
  );

  fs.writeFileSync('src/App.tsx', app, 'utf8');
  console.log('  UPDATED src/App.tsx (wired Scheduler component)');
}

console.log('\n  Done! Restart: npm run tauri:dev');
console.log('');
console.log('  New "Schedule" tab with 4 sub-tabs:');
console.log('');
console.log('  1. Shows / Dayparts');
console.log('     - Morning Drive, Midday, PM Drive, Evening, Overnight');
console.log('     - 24-hour timeline visualization');
console.log('     - Create/edit/delete shows with time ranges and colors');
console.log('');
console.log('  2. Categories (A/B/C/D rotation)');
console.log('     - Power Current / Secondary / Recurrent / Gold');
console.log('     - Set spins per hour for each category');
console.log('     - Shows song count per category');
console.log('');
console.log('  3. Format Clocks');
console.log('     - Build hourly templates: 12 songs + 2 breaks + liners');
console.log('     - Click category buttons to add slots');
console.log('     - SVG pie chart shows the clock visually');
console.log('');
console.log('  4. Schedule Grid (7x24)');
console.log('     - Assign clocks to every hour of every day');
console.log('     - Click cells to cycle through clocks');
console.log('     - Color-coded by clock');
console.log('');
console.log('  Push:');
console.log('    git add -A');
console.log('    git commit -m "v0.4.0 show scheduler + category rotation + clock builder"');
