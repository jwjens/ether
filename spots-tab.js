...
if (!client.includes('spots')) {
  ...
  console.log('  UPDATED client.ts (spots table)');
}

// ============================================================
// 2. Create Spots component
// ============================================================

fs.writeFileSync('src/components/Spots.tsx', [
...
console.log('  CREATED src/components/Spots.tsx');
...
if (!app.includes('import Spots')) {
  ...
  console.log('  UPDATED src/App.tsx (wired Spots tab)');
}

console.log('\n  Done! Restart: npm run tauri:dev');
console.log('');
console.log('  Spots tab features:');
console.log('    - Import jingles, promos, PSAs, liners, sweepers');
console.log('    - Filter by type (promo, psa, jingle, liner, etc.)');
console.log('    - Edit: title, type, advertiser, start/end dates, max plays/day');
console.log('    - Play button: fires immediately on Deck B');
console.log('    - Q button: adds to the queue');
console.log('    - Active/Inactive toggle');
console.log('    - Stats: total spots, active count, total plays');
console.log('');
console.log('  Push:');
console.log('    git add -A');
console.log('    git commit -m "v0.8.0 spots tab - promos jingles PSAs"');
