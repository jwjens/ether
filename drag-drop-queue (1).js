...
'            className={"flex items-center gap-2 px-2 py-1.5 border-b border-zinc-800 cursor-grab active:cursor-grabbing select-none " + (dragIdx === i ? "opacity-30 " : "") + (dragOverIdx === i ? "border-t-2 border-t-blue-500 " : "") + (i === 0 ? "bg-zinc-800 " : "hover:bg-zinc-800 ")}>',
