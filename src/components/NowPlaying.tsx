...
const MOCK_ADS = [
  ...
  { bg: "linear-gradient(135deg,#0c1929,#0f2744)", accent: "var(--accent-blue)", logo: "🎙️", headline: "Ether Studio", sub: "Cloud backup · Analytics · Remote dashboard", tag: "$19 / MONTH", url: "ether-technologies.com/#pricing" },
      ...
      <div style={{ position: "relative", zIndex: 1, height: "100%", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ width: 320, flexShrink: 0, background: "rgba(0,0,0,0.45)", borderRadius: 0, border: "1px solid rgba(255,255,255,0.07)", padding: "18px 18px", display: "flex", flexDirection: "column", backdropFilter: "blur(20px)" }}>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 4, overflow: "hidden" }}>
              {upcoming.length === 0
                ...
                : upcoming.map((s, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 11px", borderRadius: 0, background: i === 0 ? "rgb(from var(--accent-cyan) r g b / 0.09)" : "rgba(255,255,255,0.025)", border: `1px solid ${i === 0 ? "rgb(from var(--accent-cyan) r g b / 0.2)" : "rgba(255,255,255,0.035)"}` }}>
                    <div style={{ width: 26, height: 26, borderRadius: 0, flexShrink: 0, background: i === 0 ? "rgb(from var(--accent-cyan) r g b / 0.18)" : "rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, fontWeight: 700, color: i === 0 ? "var(--accent-cyan)" : "rgba(255,255,255,0.22)", fontFamily: "'DM Mono', monospace" }}>{i + 1}</div>
        ...
        <div style={{ padding: "14px 32px 22px", flexShrink: 0 }}>
          <div style={{ background: "rgba(0,0,0,0.7)", borderRadius: 0, padding: "16px 22px", backdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.1)", display: "flex", alignItems: "center", gap: 20 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              {isPlaying && <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: "0.22em", color: "var(--accent-cyan)", textTransform: "uppercase" as const, marginBottom: 4 }}>Now Playing</div>}
              ...
              {dur > 0 && (
                <div style={{ marginTop: 12 }}>
                  <div style={{ height: 3, background: "rgba(255,255,255,0.1)", borderRadius: 0, overflow: "hidden", marginBottom: 5 }}>
                    <div ref={progressRef} style={{ height: "100%", width: pct + "%", background: "linear-gradient(90deg,var(--accent-cyan),#8b5cf6)", borderRadius: 0, transition: "width 0.5s linear" }} />
                  </div>
