  ...
  return (
    ...
    >
      <div style={{
        ...
        overflow: "hidden",
        boxShadow: "0 40px 100px rgba(0,0,0,0.7), 0 0 0 1px rgb(from var(--accent-cyan) r g b / 0.06)",
      }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: "radial-gradient(circle, rgb(from var(--accent-cyan) r g b / 0.06) 0%, transparent 70%)",
            pointerEvents: "none",
          }} />
          <div style={{
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span style={{
                  ...
                  border: "1px solid rgb(from var(--accent-cyan) r g b / 0.25)",
        ...
        <div style={{
          ...
          {([
            ...
            <button key={t.id} onClick={() => setTab(t.id)} style={{
              ...
              color: tab === t.id ? "var(--accent-cyan)" : "rgba(255,255,255,0.35)",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                ...
                {TEAM.map(member => (
                  <div key={member.name} style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 11, color: "var(--accent-cyan)", marginBottom: 1 }}>{member.role}</div>
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {[
                    { label: "GitHub Repository", value: "github.com/jwjens/ether",   href: "https://github.com/jwjens/ether",          icon: "⌥", accent: "var(--accent-cyan)" },
                ...
                <div key={release.version}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                    <span style={{
                      ...
                      color: ri === 0 ? "var(--accent-cyan)" : "rgba(255,255,255,0.4)",
                      background: ri === 0 ? "rgb(from var(--accent-cyan) r g b / 0.1)" : "rgba(255,255,255,0.04)",
                      border: `1px solid ${ri === 0 ? "rgb(from var(--accent-cyan) r g b / 0.25)" : "rgba(255,255,255,0.06)"}`,
                      borderRadius: 0, padding: "2px 10px",
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 5, paddingLeft: 4 }}>
                    {release.changes.map((change, ci) => (
                      <div key={ci} style={{ display: "flex", alignItems: "flex-start", gap: 10, fontSize: 12, color: ri === 0 ? "rgba(255,255,255,0.6)" : "rgba(255,255,255,0.35)", lineHeight: 1.5 }}>
                        <span style={{ color: ri === 0 ? "var(--accent-cyan)" : "rgba(255,255,255,0.2)", flexShrink: 0, marginTop: 1 }}>→</span>
                        {change}
                      </div>
                    ))}
                  </div>
