      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 20 }}>
        {WIDGETS.map(w => (
          <div key={w.id} onClick={() => setWidgetType(w.id)} style={{
            ...
            background: widgetType === w.id ? "rgb(from var(--accent-cyan) r g b / 0.08)" : "var(--bg-tertiary)",
            border: `1px solid ${widgetType === w.id ? "rgb(from var(--accent-cyan) r g b / 0.35)" : "var(--border-primary)"}`,
