  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }} onClick={onClose}>
      <div onClick={e => e.stopPropagation()} style={{
        ...
        {initial.type === "tunein" && <>
          <div style={{ padding: "10px 12px", background: "rgb(from var(--accent-blue) r g b / 0.08)", border: "1px solid rgb(from var(--accent-blue) r g b / 0.2)", marginBottom: 12, fontSize: 12, color: "var(--accent-blue)", lineHeight: 1.5 }}>
