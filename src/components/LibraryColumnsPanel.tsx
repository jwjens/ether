...
const DATA_TYPE_STYLE: Record<DataType, { background: string; color: string }> = {
  ...
  number:        { background: "rgb(from var(--accent-blue) r g b / 0.12)",  color: "var(--accent-blue)" },
          ...
          <div>
            ...
            <div style={{ padding: "12px 20px 10px", background: "var(--bg-secondary)", borderBottom: "1px solid var(--border-primary)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <button
                ...
                style={{ padding: "5px 10px", borderRadius: 4, fontSize: 12, fontWeight: 600, background: formOpen ? "var(--bg-tertiary)" : "rgb(from var(--accent-blue) r g b / 0.08)", color: formOpen ? "var(--text-tertiary)" : "var(--accent-blue)", border: "1px solid " + (formOpen ? "var(--border-primary)" : "rgb(from var(--accent-blue) r g b / 0.3)"), cursor: "pointer", flexShrink: 0 }}>
                  ...
                  <div key={def.uuid}>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        background: isHighlight ? "rgb(from var(--accent-blue) r g b / 0.08)" : "transparent",
                      ...
                      onMouseLeave={isChoice ? e => { e.currentTarget.style.background = isHighlight ? "rgb(from var(--accent-blue) r g b / 0.08)" : "transparent"; } : undefined}
                    >
                      ...
                      <div style={{
                        ...
                        {vocabFormDefId === def.id ? (
                          ...
                          <button
                            ...
                            onMouseEnter={e => { e.currentTarget.style.color = "var(--accent-blue)"; e.currentTarget.style.background = "rgb(from var(--accent-blue) r g b / 0.04)"; }}
