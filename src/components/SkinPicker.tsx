...
export const PRESETS: Preset[] = [
  {
    ...
    vars: {
      ...
      "--accent-amber": "#f59e0b",
      "--wave-played":   "#00e0bf",
      "--wave-unplayed": "#2a2a33",
      "--wave-playhead": "#f59e0b",
      "--deck-a": "#ef4444",
      "--deck-b": "#3b82f6",
      "--deck-c": "#22c55e",
    }
  },
  {
    ...
    vars: {
      ...
      "--accent-cyan": "#8868D8", "--accent-red": "#F58426",
      "--accent-amber": "#F58426",
  ...
  },
  {
    ...
    vars: {
      ...
      "--accent-cyan": "#8868D8", "--accent-red": "#FDB927",
      "--accent-amber": "#FDB927",
  ...
  },
  {
    ...
    vars: {
      ...
      "--accent-cyan": "#8868D8", "--accent-red": "#CE1141",
      "--accent-amber": "#f59e0b",
  ...
  },
  {
    ...
    vars: {
      ...
      "--accent-cyan": "#8868D8", "--accent-red": "#E03A3E",
      "--accent-amber": "#C1D32F",
  ...
  },
  {
    ...
    vars: {
      ...
      "--accent-cyan": "#8868D8", "--accent-red": "#ef4444",
      "--accent-amber": "#f59e0b",
  ...
  },
  {
    ...
    vars: {
      ...
      "--accent-blue": "#006BB6", "--accent-green": "#4ade80",
      "--accent-cyan": "#8868D8", "--accent-red": "#ED174C",
      "--accent-amber": "#f59e0b",
...
export function applyTheme(vars: ThemeVars, fontStack?: string, presetId?: string) {
  ...
  const materialOverrides: Record<string, Record<string, string>> = {
    'ether-default': {
      ...
      '--panel-inner-shadow': 'none',
      '--panel-outer-shadow': 'none',
      '--vu-meter-bg': '#0a0a0f',
      '--strip-label-bg': 'transparent',
      '--strip-divider': 'rgba(255,255,255,0.06)',
      '--strip-readout-bg': 'transparent',
      '--strip-label-text': '#646b78',
      '--scale-text': 'rgba(255,255,255,0.24)',
      '--scale-text-unity': 'rgba(255,255,255,0.55)',
      '--scale-tick': 'rgba(255,255,255,0.14)',
      '--scale-tick-unity': 'rgba(255,255,255,0.5)',
      '--text-tertiary': '#646b78',
      '--panel-grain': 'none',
      '--panel-radius': '0px',
      '--fader-track-bg': '#191920',
      '--fader-thumb-gradient': '#e6e6ec',
      '--fader-thumb-shadow': 'none',
      '--fader-thumb-border': '1px solid rgba(0,0,0,0.35)',
      '--fader-thumb-radius': '2px',
      '--button-bg': '#191920',
      '--button-bg-hover': '#23232c',
      '--button-bg-active': '#2e2e39',
      ...
      '--recess-bg': '#070709',
      '--recess-inner-shadow': 'none',
      '--recess-border': '1px solid rgba(255,255,255,0.05)',
      '--recess-radius': '2px',
    },
    'newyork': {
      '--vu-meter-bg': '#0a1428',
