    ...
    >
          ...
          {isConnecting ? (
            ...
            <>
              ...
              <div style={{
                ...
                background: `linear-gradient(135deg, rgb(from var(--accent-blue) r g b / 0.3), rgba(167,139,250,0.3))`,
      ...
      <div style={{ padding: "6px 10px", borderTop: "1px solid rgba(255,255,255,0.05)", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6, minWidth: 0 }}>
          ...
          {guest.hasVideo && !guest.hidden && <span style={{ fontSize: 9, color: "rgb(from var(--accent-blue) r g b / 0.6)" }}>📷</span>}
        </div>
