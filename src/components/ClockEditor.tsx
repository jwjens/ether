...
const SLOT_META: Record<SlotType, {
  ...
  "song-a":  { label: "Power A",   color: "var(--accent-blue)", bg: "rgb(from var(--accent-blue) r g b / 0.15)",  border: "rgb(from var(--accent-blue) r g b / 0.4)",  defaultDuration: 210, icon: "A" },
          ...
          >
            ...
            {clock.slots.length > 0 && (
              <div style={{
                ...
                <Stat label="Songs" value={String(clock.slots.filter(s => s.type.startsWith("song")).length)} color="var(--accent-blue)" />
