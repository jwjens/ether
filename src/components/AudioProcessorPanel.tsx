        ...
        <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
          {PRESET_NAMES.map(name => (
            <button key={name} onClick={() => applyPreset(name)} style={{
              ...
              background: activePreset === name ? (name === "Off" ? "var(--bg-tertiary)" : "rgb(from var(--accent-blue) r g b / 0.15)") : "var(--bg-tertiary)",
              ...
              outline: activePreset === name ? `1px solid ${name === "Off" ? "var(--border-primary)" : "rgb(from var(--accent-blue) r g b / 0.3)"}` : "1px solid transparent",
            }}>{name}</button>
          ))}
        </div>
          ...
          {PRESET_NAMES.map(name => (
            <button key={name} onClick={() => applyPreset(name)} style={{
              ...
              background: activePreset === name
                ? name === "Off" ? "var(--bg-tertiary)" : "rgb(from var(--accent-blue) r g b / 0.12)"
                : "var(--bg-tertiary)",
              border: `1px solid ${activePreset === name
                ? name === "Off" ? "var(--border-primary)" : "rgb(from var(--accent-blue) r g b / 0.35)"
                : "var(--border-primary)"}`,
