...
const WARNING_RE = /REFUSED|liveDeck OBSERVER — TWO DECKS|watchdog: STALL|Bug-A guard|play-skip GUARD|FORCE stop|\[ERROR\]|\[WARN\]|advance ✗|\berrors?\b|\bfailed\b|SHADOW\] behind|LOG-READER FLOOR|LOG-READER: behind|autofit: window .* NO FIT|autofit: .*hard cut will trim|emergency floor|dead-file|unresolvable|logreader-(missed|floor)/i;
