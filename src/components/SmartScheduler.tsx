...
const ENERGY_COLORS = {
  ...
  medium: { bg: "rgba(56,189,248,0.1)", border: "rgba(56,189,248,0.25)", text: "#38bdf8", label: "Medium" },
    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column", fontFamily: "'Inter', system-ui, sans-serif", background: "var(--bg-primary)" }}>
      ...
      <div style={{ padding: "20px 24px 16px", borderBottom: "1px solid var(--border-primary)", flexShrink: 0 }}>
        ...
        {analyzing && analyzeProgress && (
          <div style={{ padding:"10px 14px", borderRadius:10, background:"rgba(56,189,248,0.08)", border:"1px solid rgba(56,189,248,0.2)", marginBottom:12 }}>
