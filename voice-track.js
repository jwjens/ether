...
console.log('\n  Ether — Voice Tracking\n');

// ============================================================
// 1. Add voice_tracks table
// ============================================================

let client = fs.readFileSync('src/db/client.ts', 'utf8');
if (!client.includes('voice_tracks')) {
  ...
  console.log('  UPDATED client.ts (voice_tracks table)');
}

// ============================================================
// 2. Create VoiceTracker component
// ============================================================

fs.mkdirSync('src/components', { recursive: true });
fs.writeFileSync('src/components/VoiceTracker.tsx', [
...
console.log('  CREATED src/components/VoiceTracker.tsx');

// ============================================================
// 3. Add Voice Tracking to nav + wire it up
// ============================================================

let app = fs.readFileSync('src/App.tsx', 'utf8');

if (!app.includes('VoiceTracker')) {
  app = app.replace(
    'import RulesEditor from "./components/RulesEditor";',
    'import RulesEditor from "./components/RulesEditor";\nimport VoiceTracker from "./components/VoiceTracker";'
  );

  // Add voicetrack panel type
  app = app.replace(
  ...
  console.log('  UPDATED src/App.tsx (Voice Track tab)');
}
...
console.log('  Voice Tracking features:');
console.log('    - Click RECORD, talk into your mic, click STOP');
console.log('    - Set DJ name and optional title');
console.log('    - Assign to a show (Morning Drive, Evening, etc.)');
console.log('    - Play back to preview');
console.log('    - Q button adds to the playback queue');
console.log('    - Recordings stored in the database');
console.log('');
console.log('  Workflow for a pre-recorded show:');
console.log('    1. Open Voice Track tab');
console.log('    2. Record "Hey Vegas, it\'s Mike, that was..."');
console.log('    3. Go to Live Assist, GEN LOG to fill the queue');
console.log('    4. Insert voice tracks between songs with Q button');
console.log('    5. Hit play — sounds like a live DJ show');
console.log('');
console.log('  Push:');
console.log('    git add -A');
console.log('    git commit -m "v0.9.1 voice tracking"');
